        ...
        <div class="ed-container">
            ...
            if ($about_query->have_posts()):
                ...
                <figure class="about-img" >
                  ...
                  <img src="<?php echo esc_url($image[0]); ?>" alt="<?php the_title_attribute(); ?>" /><?php
                  endif;
                  ?>
              </figure></a>
    ...
    <section class="case">
        <div class="ed-container">
           ...
           <div class="case-step-wrap">
               ...
               $case_args      =   array('cat'=>$ed_case_cat, 'post_status'=>'publish', 'posts_per_page'=>4,'order'=>'Asc');
...
<section class="practice-section">
    <div class="ed-container">
        ...
        $practice_btn_text = get_theme_mod('eightlaw_lite_practice_button_text',__('Подробнее...','eightlaw-lite'));
        ...
        <div class="practice-list">
            ...
            <div class="practice-desc">
                ...
                <div class="btn-wrapper">
                    <a class="practice-btn bttn" href="<?php echo $practice_btn_link;?>"><?php echo esc_html($practice_btn_text);?></a>
                </div>
            </div>
            <?php   }
            else{
                ...
                <div class="practice-desc-full">
                    ...
                    <p><?php echo wp_kses_post($ed_practice_desc);?></p>
                    <div class="btn-wrapper">
                        <a class="practice-btn btn" href="<?php echo $practice_btn_link;?>"><?php echo esc_html($practice_btn_text);?></a>
                    </div>
        ...
        <ul class="gallery">
            ...
            <li>
                ...
                <div class="gallery-view-link">
                    <a href="<?php echo esc_url($image[0]);?>"><i class="fa fa-search-plus"></i></a>
                </div>
            </li>
...
if(get_theme_mod('eightlaw_lite_benefit_setting_option','disable')=='enable' ||
        ...
        <div class="wrap-bct">
            <div class="ed-container">
                ...
                <section class="benefit">
                    ...
                    <?php
                    $bf_args    =   array('cat'=>$ed_bf_cat, 'post_status'=>'publish', 'posts_per_page'=>3);
     ...
     if(get_theme_mod('eightlaw_lite_clientlogo_setting_option','disable')=='enable'){
         ...
         <section class="clients-logo">
            ...
            <div class="clients-logo-wrapper">
                <?php
                $port_args      =   array('cat'=>$ed_cl_cat, 'post_status'=>'publish', 'posts_per_page'=>3);
    ...
    <section class="testimonial">
        ...
        <div class="testimonial-slider">
            <?php
            $tm_args    =   array('cat'=>$ed_tm_cat, 'post_status'=>'publish','posts_per_page'=>2);
    ...
    <section class="our-team-member">
        <div class="ed-container">
           ...
           <div class="team-member-wrap">
               ...
               $team_args      =   array('cat'=>$ed_team_cat, 'post_status'=>'publish', 'posts_per_page'=>4);
            ...
            <div class="team-block">
                <figure class="team-image">
                    <div class="team-img">
                        <?php if (has_post_thumbnail()):
                        $image = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()),'eightlaw-lite-blog-medium'); ?>
...
if(get_theme_mod('eightlaw_lite_blog_setting_option','disable')=='enable'){
    ...
    <section class="blog-section">
     <div class="ed-container">
        ...
        <div class="blog-wrap">
         <?php
         $blog_args      =   array('cat'=>$ed_blog_cat, 'post_status'=>'publish', 'posts_per_page'=>3);
           ...
           <div class="wrap-latest">
                ...
                <?php if(get_theme_mod('eightlaw_lite_latestpost_setting_option','disable')=='enable'){
                   ...
                   <section class="latest-post">
                    ...
                    <div class="post-slider">
                        ...
                        <?php
                        $read_more_archive = get_theme_mod('eightlaw_lite_latestpost_readmore',__('Подробнее...','eightlaw-lite'));
                        $args_posts = array(
                            'post_type' => 'post',
            ...
            <section class="latestnews">
                ...
                <div class="latestnews-slider">
                    <?php
                    $ln_args    =   array('cat'=>$ed_ln_cat, 'post_status'=>'publish','posts_per_page' => 2, );
                    ...
                    <div class="ln-slider">
                        ...
                        ?>
                        <div class="news-content"><?php echo eightlaw_lite_excerpt(get_the_content(), 160);?></div>
                        <div class="btn"><a href="<?php the_permalink();?>"><?php echo esc_html(get_theme_mod('eightlaw_lite_latestnews_readmore',__('Подробнее...','eightlaw-lite')));?> </a></div>
