...
add_thickbox();
$eightlaw_lite_recommended_plugins = array(
	...
	<div class="feature-section recommended-plugins">
		<?php foreach ( $eightlaw_lite_recommended_plugins as $plugin => $prop ) { ?>
		<?php
		...
		switch ( $active['needs'] ) {
			...
			$label = __( 'Install', 'eightlaw-lite' );
			break;
			case 'activate':
			$class = 'activate-now button button-primary';
			$label = __( 'Activate', 'eightlaw-lite' );
			break;
			case 'deactivate':
			$class = 'deactivate-now button';
			$label = __( 'Deactivate', 'eightlaw-lite' );
			break;
		}
		...
		<div class="col plugin_box">
			<?php if ( $prop['recommended'] ): ?>
				<span class="recommended"><?php _e( 'Required', 'eightlaw-lite' ); ?></span>
			<?php endif; ?>
			...
			<div class="b-wrap">
			<span class="version"><?php echo __( 'Version:', 'eightlaw-lite' ); ?><?php echo esc_html( $info->version ) ?></span>
