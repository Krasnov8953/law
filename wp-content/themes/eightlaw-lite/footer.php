      ...
      <div id="bottom-footer">
            <div class="ed-container">
              <div class="copyright wow fadeInLeft" data-wow-delay="0.3s">
                            ...
                            <!-- <?php esc_html_e( 'WordPress Theme : ', 'eightlaw-lite' );  ?><a  title="<?php echo __('Free WordPress Theme','eightlaw-lite');?>" href="<?php echo esc_url( __( 'https://8degreethemes.com/wordpress-themes/eightlaw-lite/', 'eightlaw-lite' ) ); ?>"><?php esc_html_e( 'Eightlaw Lite', 'eightlaw-lite' ); ?> </a>
